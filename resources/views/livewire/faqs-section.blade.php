<div class="">
    <div class="space-y-4 max-w-7xl lg:px-0 mx-auto  lg:my-30 ">
        <h2 class="text-3xl/tight font-bold text-gray-900 sm:text-4x">FAQs</h2>

        <details class="group border-s-4 border-gray-200 bg-gray-50 p-4 [&amp;_summary::-webkit-details-marker]:hidden">
